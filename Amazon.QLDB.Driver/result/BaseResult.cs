...
namespace Amazon.QLDB.Driver
{
    ...
    {
        protected readonly IonEnumerator ionEnumerator;
        protected bool isRetrieved = false;
        ...
        /// </summary>
        protected class IonEnumerator : IEnumerator<IIonValue>
        {
            ...
            internal IOUsage? GetConsumedIOs()
            {
                ...
                return new IOUsage((long)this.readIOs, (long)this.writeIOs);
            }
            ...
            internal TimingInformation? GetTimingInformation()
            {
                ...
                return new TimingInformation((long)this.processingTimeMilliseconds);
            }
