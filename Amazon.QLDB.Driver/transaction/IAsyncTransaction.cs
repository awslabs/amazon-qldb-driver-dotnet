...
namespace Amazon.QLDB.Driver
{
    ...
    /// <summary>
    /// <para>Interface that represents an active asynchronous transaction with QLDB.</para>
    ///
    ...
    /// </summary>
    internal interface IAsyncTransaction : IAsyncDisposable, IAsyncExecutable
    {
        string Id { get; }
