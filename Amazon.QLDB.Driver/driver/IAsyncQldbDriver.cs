...
namespace Amazon.QLDB.Driver
{
    ...
    public interface IAsyncQldbDriver : IDisposable
    {
        ...
        void Execute(Action<AsyncTransactionExecutor> action);
        ...
        void Execute(Action<AsyncTransactionExecutor> action, Action<int> retryAction);
        ...
        /// <exception cref="QldbDriverException">Thrown when called on a disposed instance.</exception>
        /// <exception cref="AmazonServiceException">Thrown when there is an error executing against QLDB.</exception>
        void Execute(Action<AsyncTransactionExecutor> action, RetryPolicy retryPolicy);
        ...
        /// <exception cref="QldbDriverException">Thrown when called on a disposed instance.</exception>
        /// <exception cref="AmazonServiceException">Thrown when there is an error executing against QLDB.</exception>
        T Execute<T>(Func<AsyncTransactionExecutor, T> func);
        ...
        /// <exception cref="AmazonServiceException">Thrown when there is an error executing against QLDB.</exception>
        [Obsolete("As of release 1.0, replaced by 'retryPolicy'. Will be removed in the next major release.")]
        T Execute<T>(Func<AsyncTransactionExecutor, T> func, Action<int> retryAction);
        ...
        /// <exception cref="QldbDriverException">Thrown when called on a disposed instance.</exception>
        /// <exception cref="AmazonServiceException">Thrown when there is an error executing against QLDB.</exception>
        T Execute<T>(Func<AsyncTransactionExecutor, T> func, RetryPolicy retryPolicy);
